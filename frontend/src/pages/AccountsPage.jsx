...
export function AccountsPage() {
  ...
  return <section className="page-stack">
    ...
    {form ? <FormDrawer open eyebrow={editingAccount ? "Editar conta" : "Nova conta"} title={editingAccount ? editingAccount.name : "Adicionar uma conta"} onClose={closeEditors}><form className="entity-form" onSubmit={submitAccount}>
